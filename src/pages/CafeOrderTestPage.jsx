...
export const menuList = {
  drinks: ['올타임콜드브루', '(1호점)신촌커피', '바닐라 카페라떼', '카라멜 마끼아또', '스페니쉬 연유 카페라떼', '달고나 카페라떼', '딸기 젤리 밀크티', '23수박주스', '아인슈페너 프라페', '스트로베리 초콜릿 프라페', '블루밍 파인애플 라씨', '20곡 오틀리 라떼'],
  desserts: ['베이컨 체다 베이글', '멕시칸 파니니', '바베큐치킨 파니니', '떠먹는 티라미수', '떠먹는 아이스 박스', 'P. 뉴욕치즈', 'P. 클래식 가토 쇼콜라', 'P. 레드 벨벳', 'P. 퀸즈 캐롯', '황치즈 마카롱', '청포도 요거트 마카롱', '산딸기 마카롱', '블루베리 마카롱', '벨지안 초콜릿 마카롱']
}
